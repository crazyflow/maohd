 ...
 * 客服统计
 */
public class LogisticsReport implements java.io.Serializable
{
    /**
     * 
     */
    private static final long serialVersionUID = 4534895065698193765L;
    ...
    {
        this.costPriceByCurrency=this.costCurrencyCode + nf.format(this.costPrice);
    ...
    public String getProfit()
    {
        ...
        else if (this.costCurrencyId != this.customerCurrencyId)
        {
            this.profit = (this.currencyCode + nf.format(this.customerPrice)) + "-"
                    + (this.costCurrencyCode + nf.format(this.costPrice));
        }
        return profit;
    }
    ...
    public String getLogisticsBusId()
    {
        return logisticsBusId;
    }

    public void setLogisticsBusId(String logisticsBusId)
    {
        this.logisticsBusId = logisticsBusId;
    }
