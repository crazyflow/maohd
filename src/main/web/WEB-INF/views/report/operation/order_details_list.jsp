  ...
  <div class="body">
    <div class="page-body">
      <div class="page-title">
        订单统计报表(明细)
        <a href="javascript:exportExcel()" seed=101207009 class="btn btn-creat">导出Excel</a>
      </div>
      <form id="formLessSearch">
        <div class="search-area">
          <div class="search-group">
            <label>客服人员：</label>
            <select seed=101207001 id="customerService" class="form-control" name="customerServiceId">
              <option value="">全部</option>
            </select>
          </div>
          <div class="search-group">
            <label>委托客户：</label>
            <input seed=101207002 class="form-control" name="companyName" type="text" maxlength="30">
          </div>
          <div class="search-group">
            <label>订单号：</label>
            <input seed=101207003 class="form-control" name="orderCode" type="text" maxlength="30">
          </div>
        </div>
        <div class="search-group">
          <button class="btn btn-default btn-search" seed=101207004 type="button" onclick="refreshDatas()">查询</button>
          <a class="more-criteria" seed=101207005 href="javascript:moreConditions()">更多条件∨</a>
        </div>
      </form>
      <form id="formMoreSearch">
        <div class="search-area">
          <div class="search-group">
            <label>客服人员：</label>
            <select seed=101207001 id="customerServiceMore" class="form-control" name="customerServiceId">
              <option value="">全部</option>
            </select>
          </div>
          <div class="search-group">
          ...
          <div class="search-group">
            <label>日期：</label>
            <input seed=101207006 readonly="readonly" type="text" class="active"  id="txt" value="" name="BeginDate_EndDate" class="">
            <input type="hidden" id="hidBegin" name="beginDate" value="">
            <input type="hidden" id="hidEnd" name="endDate" value="">
          </div>
          <div class="search-group">
            <label>开票人：</label>
            <input seed=101207007 class="form-control" name="supplierName" type="text" maxlength="30">
          </div>
        </div>
        <div class="search-group">
          <button seed=101207004 class="btn btn-default btn-search" type="button" onclick="refreshDatas()">查询</button>
          <a id="linkLess" seed=101207008 class="close-criteria" href="javascript:lessConditions()">收起条件∧</a>
        </div>
      </form>
      <div id="table"></div>
    </div>
...
<script type="text/javascript">
	...
	function refreshDatas(isCurrentPage) {
		...
		var url = "${contextPath}/operation/order-details?format=table&"
				+ searchParam;
	...
	function exportExcel() {
		...
		location.href = "${contextPath}/operation/order-details/excel?" + param;
	}
</script>